...
namespace Buckets
{
    ...
    public class PatternBucket : GenericAssetBucket<PatternBehaviour>
    {
        ...
        /// <summary>
        /// Refreshes the list of PatternBehaviour assets in the bucket.
        /// Clears old references, searches for assets in 'Assets/ScriptableObjects/Patterns',
        /// and adds found assets to the bucket.
        /// </summary>
